        ...
        <div class="container">
            <div class="contactinfo">
                <div class="box">
                    ...
                    <div class="text">
                        <h3>Address</h3>
                        <p>3838 Bootcamp Road, <br>Brooklyn, New York,<br>11314</p>
                    </div>
                </div>
                <div class="box">
            ...
            <div class="contactform">
                <form action="/frontend/support/ty.php">
                    ...
                    <div class="inputbox">
                        <textarea required="required" placeholder="Type your question or comment here"></textarea>

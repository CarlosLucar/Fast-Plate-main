...
<div class="partner-form">
    <form action="/frontend/contact/ty.php" method="post">
        ...
        <input type="text" id="email" name="emal" placeholder="Email"><br>
        ...
        <select id="state" name="state">
            ...
            <option value="canada">Arizona</option>
        ...
        <br>
        <br>
        <label for="subject">Explain why you would like to partner with us:</label>
        <br>
